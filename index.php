...
<html lang="pt-br">
    ...
    <body>
        ...
        <hr/>
        <br/>
        <center><button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#exampleModal">CADASTRAR PESSOA</button></center>
        <br/>
        <main>
            <div class="conteiner">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="cadpessoa.php" method="post">
                            <label>NOME</label>
                            <input type="text" class="form-control" name="nome" placeholder="Digite o nome da pessoa" required/>
                            <label>IDADE</label>
                            <input type="number" class="form-control" name="idade" required/>
                            <label>CIDADE</label>
                            <input type="text" class="form-control" name="cidade" placeholder="Digite a cidade da pessoa" required/>
                            <br/>
                            <button type="submit" class="btn btn-outline-success"><b>CADASTRAR</b>
                        </form>
                    </div>
